...
function GetStart({getStart,setGetStarted}) {
    return (
        <div>
            ...
            py-2 px-4 border dark:border-neutral-800 dark:hover:border-black border-blue-700 rounded text-md" onClick={()=>setGetStarted((prev)=>!prev)}>
                {getStart? "Get start":"Back"}
            </button>
        </div>
    )
}
